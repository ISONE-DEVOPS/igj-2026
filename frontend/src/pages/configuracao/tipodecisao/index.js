...
const pageAcess = "/configuracao/tipodecisao"
...
const Customers = () => {
    ...
    async function editarItemGO(event) {
        ...
        try {
            ...
            const response = await api.put('/sgigjprdecisaotp/' + itemSelected.ID, upload);
    ...
    async function criarItemGO(event) {
        ...
        try {
            ...
            const response = await api.post('/sgigjprdecisaotp', upload);
    ...
    const removeItemFunction = async (idx) => {
        ...
        try {
            ...
            const response = await api.delete('/sgigjprdecisaotp/' + idx);
            ...
            <Row>
                <Col sm={12}>
                        ...
                        <Modal.Body className="newuserbox" >
                            ...
                            <form id="editarItem" onSubmit={editarItemGO} >
                                ...
                                <Row>
                                    ...
                                    <div className="col-sm-12">
                                        <div className="form-group fill">
                                            <label className="floating-label" htmlFor="Address">Designação <span style={{ color: "red" }} >*</span></label>
                    ...
                    <Modal size='x' show={isVerOpen} onHide={() => setVerOpen(false)}>
                        <Modal.Header closeButton>
                            <Modal.Title as="h5">Tipo de Evento</Modal.Title>
                        </Modal.Header>
                        <Modal.Body className="newuserbox" >
                            ...
                            <Row style={{ width: "100%", overflow: "auto" }}>
                                ...
                                <div className="col-sm-12" style={{ overflow: "hidden" }}>
                                    <div className="form-group fill">
                                        ...
                                        <label style={{ overflow: "auto", height: "auto", minHeight: "33px" }} className="form-control" >{itemSelected.DESIG}</label>
