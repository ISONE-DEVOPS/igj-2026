...
const pageAcess = "/configuracao/tipocargo"
...
const Customers = () => {
    ...
    async function uploadlist() {
        ...
        try {
            ...
            const response = await api.get('/sgigjprcontactotxxxxxx');
    ...
    async function editarItemGO(event) {
        ...
        try {
            ...
            const response = await api.put('/sgigjprcontactotxxxxxx/' + itemSelected.ID, upload);
    ...
    async function criarItemGO(event) {
        ...
        try {
            ...
            const response = await api.post('/sgigjprcontactotxxxxxx', upload);
    ...
    const removeItemFunction = async (idx) => {
        ...
        try {
            ...
            const response = await api.delete('/sgigjprcontactotxxxxxx/' + idx);
            ...
            <Row>
                <Col sm={12}>
                                ...
                                <Row>
                                    ...
                                    <Col sm={8}>
                                        <div className="form-group fill">
                                            ...
                                            <input type="text" onChange={event => { setDESIG_C(event.target.value) }} defaultValue={""} className="form-control" placeholder="Designação..." required />
                                        </div>
                                    </Col>
                                    ...
                                    <div className="col-sm-12">
                                        <div className="form-group fill">
                                            ...
                                            <textarea className="form-control" onChange={event => { setOBS_C(event.target.value) }} defaultValue={""} rows="3" placeholder='Descrição...' />
                                        </div>
                                    </div>
                            ...
                            <form id="editarItem" onSubmit={editarItemGO} >
                                ...
                                <Row>
                                    ...
                                    <Col sm={8}>
                                        <div className="form-group fill">
                                            <label className="floating-label" htmlFor="Name">Designação <span style={{ color: "red" }} >*</span></label>
                                            <input type="text" onChange={event => { setDESIG_C(event.target.value) }} defaultValue={itemSelected.DESIG} className="form-control" id="Utilizador" placeholder="Designação..." required />
                                        </div>
                                    </Col>
                                    ...
                                    <div className="col-sm-12">
                                        <div className="form-group fill">
                                            <label className="floating-label" htmlFor="Address">Descrição</label>
                                            <textarea className="form-control" onChange={event => { setOBS_C(event.target.value) }} defaultValue={itemSelected.OBS} id="Address" rows="3" placeholder='Descrição...' />
                                        </div>
                                    </div>
                    ...
                    <Modal size='x' show={isVerOpen} onHide={() => setVerOpen(false)}>
                        <Modal.Header closeButton>
                            <Modal.Title as="h5">Tipo de Cargo</Modal.Title>
                        </Modal.Header>
                        <Modal.Body className="newuserbox" >
