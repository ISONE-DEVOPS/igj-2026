...
const pageAcess = "/configuracao/modalidadepagamento"
...
const ModalidadePagamento = () => {
    ...
    async function editarItemGO(event) {
        ...
        try {
            ...
            const response = await api.put('/modalidadepagamento/' + itemSelected.ID, upload);
    ...
    async function criarItemGO(event) {
        ...
        try {
            ...
            const response = await api.post('/modalidadepagamento', upload);
    ...
    const removeItemFunction = async (idx) => {
        ...
        try {
            ...
            const response = await api.delete('/modalidadepagamento/' + idx);
                                ...
                                <Row>
                                    ...
                                    <Col sm={12}>
                                        <div className="form-group fill">
                                            ...
                                            <textarea onChange={event => { setOBS(event.target.value) }} defaultValue={""} className="form-control" maxLength="64000" rows="3" placeholder='Observação...' />
                                        </div>
                                    </Col>
                            ...
                            <form id="editarItem" onSubmit={editarItemGO} >
                                ...
                                <Row>
                                    ...
                                    <Col sm={12}>
                                        <div className="form-group fill">
                                            <label className="floating-label" htmlFor="Name">Designação <span style={{ color: "red" }} >*</span></label>
                                            <input type="text" maxLength="128" onChange={event => { setDESIGNACAO(event.target.value) }} defaultValue={itemSelected.DESIGNACAO} className="form-control" id="Utilizador" placeholder="Designação..." required />
                                        </div>
                                    </Col>
                                    ...
                                    <Col sm={12}>
                                        <div className="form-group fill">
                                            ...
                                            <textarea onChange={event => { setOBS(event.target.value) }} defaultValue={itemSelected.OBS} className="form-control" maxLength="64000" rows="3" placeholder='Observação...' />
                                        </div>
                                    </Col>
...
export default ModalidadePagamento;