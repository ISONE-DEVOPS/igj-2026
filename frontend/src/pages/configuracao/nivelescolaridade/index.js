...
const pageAcess = "/configuracao/nivelescolaridade"
...
const Customers = () => {
    ...
    async function editarItemGO(event) {
        ...
        try {
            ...
            const response = await api.put('/sgigjprnivelescolaridade/' + itemSelected.ID, upload);
    ...
    async function criarItemGO(event) {
        ...
        try {
            ...
            const response = await api.post('/sgigjprnivelescolaridade', upload);
    ...
    const removeItemFunction = async (idx) => {
        ...
        try {
            ...
            const response = await api.delete('/sgigjprnivelescolaridade/' + idx);
            ...
            <Row>
                <Col sm={12}>
                    ...
                    <Modal size='x' show={isVerOpen} onHide={() => setVerOpen(false)}>
                        <Modal.Header closeButton>
                            <Modal.Title as="h5">Nível Escolaridade</Modal.Title>
                        </Modal.Header>
                        <Modal.Body className="newuserbox" >
