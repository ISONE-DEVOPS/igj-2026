...
const pageAcess = "/configuracao/meiopagamento"
...
const MeioPagamento = () => {
    ...
    const [TEM_NUMERO, setTEM_NUMERO] = useState(0);
    ...
    async function editarItemGO(event) {
        ...
        try {
            ...
            const response = await api.put('/meiospagamento/' + itemSelected.ID, upload);
    ...
    async function criarItemGO(event) {
        ...
        try {
            ...
            const response = await api.post('/meiospagamento', upload);
    ...
    const removeItemFunction = async (idx) => {
        ...
        try {
            ...
            const response = await api.delete('/meiospagamento/' + idx);
                                ...
                                <Row>
                                    ...
                                    <Col sm={12}>
                                        <div className="form-group fill">
                                            ...
                                            <label className="floating-label ml-2" htmlFor="Address">É Cheque ?</label>
                                        </div>
                                    </Col>
                        ...
                        <Modal.Body className="newuserbox" >
                            ...
                            <form id="editarItem" onSubmit={editarItemGO} >
                                ...
                                <Row>
                                    ...
                                    <Col sm={12}>
                                        <div className="form-group fill">
                                            <input type="checkbox" name="" id="" onChange={e => handleChange(e.target.checked)} defaultChecked={itemSelected.TEM_NUMERO === 1 ? true : false} />
                                            <label className="floating-label ml-2" htmlFor="Address">É Cheque ?</label>
                                        </div>
                                    </Col>
