...
const pageAcess = "/configuracao/exclusaoperiodo"
...
const Customers = () => {
    ...
    async function editarItemGO(event) {
        ...
        try {
            ...
            const response = await api.put('/sgigjprexclusaoperiodo/' + itemSelected.ID, upload);
    ...
    async function criarItemGO(event) {
        ...
        try {
            ...
            const response = await api.post('/sgigjprexclusaoperiodo', upload);
    ...
    const removeItemFunction = async (idx) => {
        ...
        try {
            ...
            const response = await api.delete('/sgigjprexclusaoperiodo/' + idx);
            ...
            <Row>
                <Col sm={12}>
                            ...
                            <form id="criarItem" onSubmit={criarItemGO} >
                                ...
                                <Row>
                                    ...
                                    <div className="col-sm-12">
                                        <div className="form-group fill">
                                            <label className="floating-label" htmlFor="Address">Número de dias de Exclusão <span style={{ color: "red" }} >*</span></label>
                                            <input type="number" max="9999999" min="0" className="form-control" onChange={event => { setNUM_DIAS(event.target.value) }} defaultValue={""} placeholder='Número...' required />
                                        </div>
                                    </div>
                            ...
                            <form id="editarItem" onSubmit={editarItemGO} >
                                ...
                                <Row>
                                    ...
                                    <div className="col-sm-12">
                                        <div className="form-group fill">
                                            <label className="floating-label" htmlFor="Address">Número de dias de Exclusão <span style={{ color: "red" }} >*</span></label>
                                            <input type="number" max="9999999" min="0" className="form-control" defaultValue={itemSelected.NUM_DIAS} onChange={event => { setNUM_DIAS(event.target.value) }} placeholder='Número...' required />
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-sm-12">
                                        <div className="form-group fill">
                                            <label className="floating-label" htmlFor="Address">Descrição</label>
                                            <textarea maxLength="64000" className="form-control" onChange={event => { setOBS_C(event.target.value) }} defaultValue={itemSelected.OBS} rows="3" placeholder='Descrição...' />
                                        </div>
                                    </div>
                    ...
                    <Modal size='x' show={isVerOpen} onHide={() => setVerOpen(false)}>
                        <Modal.Header closeButton>
                            <Modal.Title as="h5">Periodo </Modal.Title>
                        </Modal.Header>
                        <Modal.Body className="newuserbox" >
                            ...
                            <Row style={{ width: "100%", overflow: "auto" }}>
                                ...
                                <div className="col-sm-12">
                                    <div className="form-group fill">
                                        <label className="floating-label" htmlFor="Address">Número de dias de Exclusão</label>
                                        <label style={{ overflow: "auto", height: "auto", minHeight: "33px" }} className="form-control">{itemSelected.NUM_DIAS}</label>
