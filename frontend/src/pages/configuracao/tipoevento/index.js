...
const pageAcess = "/configuracao/tipoevento"
...
const Customers = () => {
    ...
    async function editarItemGO(event) {
        ...
        try {
            ...
            const response = await api.put('/sgigjpreventotp/' + itemSelected.ID, upload);
    ...
    const removeItemFunction = async (idx) => {
        ...
        try {
            ...
            const response = await api.delete('/sgigjpreventotp/' + idx);
