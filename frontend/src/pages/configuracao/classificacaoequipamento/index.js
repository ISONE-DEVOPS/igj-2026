...
const pageAcess = "/configuracao/classificacaoequipamento"
...
const Customers = () => {
    ...
    const [CLASSIFICACAO_C, setCLASSIFICACAO_C] = useState("");
    ...
    const openEditHandler = (idx) => {
        ...
        setID_C(idx.ID)
        setCLASSIFICACAO_C(idx.CLASSIFICACAO)
        setOBS_C(idx.OBS)
        //setESTADO_C(idx.ID)
    };
    ...
    async function editarItemGO(event) {
        ...
        try {
            ...
            const response = await api.put('/sgigjprequipamentoclassificacao/' + itemSelected.ID, upload);
    ...
    const removeItemFunction = async (idx) => {
        ...
        try {
            ...
            const response = await api.delete('/sgigjprequipamentoclassificacao/' + idx);
            ...
            <Row>
                <Col sm={12}>
                                ...
                                <Row>
                                    ...
                                    <Col sm={8}>
                                        <div className="form-group fill">
                                            ...
                                            <input type="text" maxLength="64" onChange={event => { setCLASSIFICACAO_C(event.target.value) }} defaultValue={""} className="form-control" placeholder="Classificação..." required />
                                        </div>
                                    </Col>
                            ...
                            <form id="editarItem" onSubmit={editarItemGO} >
                                ...
                                <Row>
                                    ...
                                    <Col sm={8}>
                                        <div className="form-group fill">
                                            <label className="floating-label" htmlFor="Name">Classificação <span style={{ color: "red" }} >*</span></label>
                                            <input type="text" maxLength="64" onChange={event => { setCLASSIFICACAO_C(event.target.value) }} defaultValue={itemSelected.CLASSIFICACAO} className="form-control" id="Utilizador" placeholder="Classificação..." required />
                                        </div>
                                    </Col>
                    ...
                    <Modal size='x' show={isVerOpen} onHide={() => setVerOpen(false)}>
                        <Modal.Header closeButton>
                            <Modal.Title as="h5">Classificação</Modal.Title>
                        </Modal.Header>
                        <Modal.Body className="newuserbox" >
