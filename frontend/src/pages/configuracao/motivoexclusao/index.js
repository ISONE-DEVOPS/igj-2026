...
const pageAcess = "/configuracao/motivoexclusao"
...
const Customers = () => {
    ...
    async function editarItemGO(event) {
        ...
        try {
            ...
            const response = await api.put('/sgigjprmotivoesclusaotp/' + itemSelected.ID, upload);
    ...
    async function criarItemGO(event) {
        ...
        try {
            ...
            const response = await api.post('/sgigjprmotivoesclusaotp', upload);
    ...
    const removeItemFunction = async (idx) => {
        ...
        try {
            ...
            const response = await api.delete('/sgigjprmotivoesclusaotp/' + idx);
            ...
            <Row>
                <Col sm={12}>
                    ...
                    <Modal size='x' show={isVerOpen} onHide={() => setVerOpen(false)}>
                        <Modal.Header closeButton>
                            <Modal.Title as="h5">Motivo</Modal.Title>
                        </Modal.Header>
                        <Modal.Body className="newuserbox" >
