...
const pageAcess = "/configuracao/tipomaquina"
...
const Customers = () => {
    ...
    async function editarItemGO(event) {
        ...
        try {
            ...
            const response = await api.put('/sgigjprmaquinatp/' + itemSelected.ID, upload);
    ...
    const removeItemFunction = async (idx) => {
        ...
        try {
            ...
            const response = await api.delete('/sgigjprmaquinatp/' + idx);
            ...
            <Row>
                <Col sm={12}>
                    ...
                    <Modal size='x' show={isVerOpen} onHide={() => setVerOpen(false)}>
                        <Modal.Header closeButton>
                            <Modal.Title as="h5">Tipo de Máquina</Modal.Title>
                        </Modal.Header>
                        <Modal.Body className="newuserbox" >
