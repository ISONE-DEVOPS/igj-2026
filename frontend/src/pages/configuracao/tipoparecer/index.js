...
const pageAcess = "/configuracao/tipoparecer"
...
const TipoParecer = () => {
    ...
    async function editarItemGO(event) {
        ...
        try {
            ...
            const response = await api.put('/parecerparametrizacao/' + itemSelected.ID, upload);
    ...
    async function criarItemGO(event) {
        ...
        try {
            ...
            const response = await api.post('/parecerparametrizacao', upload);
    ...
    const removeItemFunction = async (idx) => {
        ...
        try {
            ...
            const response = await api.delete('/parecerparametrizacao/' + idx);
                            ...
                            <form id="criarItem" onSubmit={criarItemGO} >
                                ...
                                <Row>
                                    ...
                                    <div className="col-sm-12">
                                        <div className="form-group fill">
                                            <label className="floating-label" htmlFor="Address">Nome <span style={{ color: "red" }} >*</span></label>
                                            <input maxLength="128" type="text" onChange={event => { setNOME(event.target.value) }} defaultValue={""} className="form-control" placeholder="Designação..." required />
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-sm-12">
                                        <div className="form-group fill">
                                            ...
                                            <textarea maxLength="64000" className="form-control" onChange={event => { setDESCRICAO(event.target.value) }} defaultValue={""} rows="3" placeholder='Descrição...' />
                                        </div>
                                    </div>
                            ...
                            <form id="editarItem" onSubmit={editarItemGO} >
                                ...
                                <Row>
                                    ...
                                    <div className="col-sm-12">
                                        <div className="form-group fill">
                                            <label className="floating-label" htmlFor="Address">Nome <span style={{ color: "red" }} >*</span></label>
                                            <input maxLength="128" type="text" onChange={event => { setNOME(event.target.value) }} defaultValue={itemSelected.NOME} className="form-control" id="Utilizador" placeholder="Designação..." required />
                                        </div>
                                    </div>

                                    <div className="col-sm-12">
                                        <div className="form-group fill">
                                            <label className="floating-label" htmlFor="Address">Descrição
                                            </label>
                                            <textarea maxLength="64000" className="form-control" onChange={event => { setDESCRICAO(event.target.value) }} defaultValue={itemSelected.DESCRICAO} id="Address" rows="3" placeholder='Descrição...' />
                                        </div>
                                    </div>
                        ...
                        <Modal.Body className="newuserbox" >
                            ...
                            <Row style={{ width: "100%", overflow: "auto" }}>
                                ...
                                <div className="col-sm-12" style={{ overflow: "hidden" }}>
                                    <div className="form-group fill">
                                        <label className="floating-label" htmlFor="Address">Nome</label>
                                        <label style={{ overflow: "auto", height: "auto", minHeight: "33px" }} className="form-control" >{itemSelected.NOME}</label>
                                ...
                                <div className="col-sm-12">
                                    <div className="form-group fill">
                                        ...
                                        <label style={{ overflow: "auto", height: "auto", minHeight: "33px" }} className="form-control">{itemSelected.DESCRICAO}</label>
