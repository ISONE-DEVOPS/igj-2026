...
const pageAcess = "/configuracao/tipoorigem"
...
const Customers = () => {
    ...
    async function uploadlist() {
        ...
        try {
            ...
            const response = await api.get('/sgigjprorigemtp');
    ...
    async function editarItemGO(event) {
        ...
        try {
            ...
            const response = await api.put('/sgigjprorigemtp/' + itemSelected.ID, upload);
    ...
    async function criarItemGO(event) {
        ...
        try {
            ...
            const response = await api.post('/sgigjprorigemtp', upload);
    ...
    const removeItemFunction = async (idx) => {
        ...
        try {
            ...
            const response = await api.delete('/sgigjprorigemtp/' + idx);
            ...
            <Row>
                <Col sm={12}>
                    ...
                    <Modal size='x' show={isVerOpen} onHide={() => setVerOpen(false)}>
                        <Modal.Header closeButton>
                            <Modal.Title as="h5">Tipo de Origem</Modal.Title>
                        </Modal.Header>
                        <Modal.Body className="newuserbox" >
                            ...
                            <Row>
                                ...
                                <div className="col-sm-12">
                                    <div className="form-group fill">
                                        <label className="floating-label" htmlFor="Address">Descrição</label>
                                        <label className="form-control">{itemSelected.OBS}</label>
