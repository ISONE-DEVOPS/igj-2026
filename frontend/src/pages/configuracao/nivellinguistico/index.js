...
const pageAcess = "/configuracao/nivellinguistico"
...
const Customers = () => {
    ...
    async function editarItemGO(event) {
        ...
        try {
            ...
            const response = await api.put('/sgigjprnivellinguistico/' + itemSelected.ID, upload);
    ...
    async function criarItemGO(event) {
        ...
        try {
            ...
            const response = await api.post('/sgigjprnivellinguistico', upload);
    ...
    const removeItemFunction = async (idx) => {
        ...
        try {
            ...
            const response = await api.delete('/sgigjprnivellinguistico/' + idx);
            ...
            <Row>
                <Col sm={12}>
                    ...
                    <Modal size='x' show={isVerOpen} onHide={() => setVerOpen(false)}>
                        <Modal.Header closeButton>
                            <Modal.Title as="h5">Nível Linguístico</Modal.Title>
                        </Modal.Header>
                        <Modal.Body className="newuserbox" >
