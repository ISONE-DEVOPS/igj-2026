...
const pageAcess = "/administracao/perfil"
...
const Customers = () => {
    ...
    async function editarItemGO(event) {
        ...
        try {
            ...
            const response = await api.put('/glbperfil/' + itemSelected.ID, upload);
    ...
    async function criarItemGO(event) {
        ...
        try {
            ...
            const response = await api.post('/glbperfil', upload);
    ...
    const removeItemFunction = async (idx) => {
        ...
        try {
            ...
            const response = await api.delete('/glbperfil/' + idx);
            ...
            if (err.response.data.code == "246") popUp_alertaOK("Esse perfil não pode ser eliminado")
            else popUp_alertaOK("Falha. Tente mais tarde")
            ...
            <Row>
                <Col sm={12}>
                                ...
                                <Row>
                                    ...
                                    <Col sm={8}>
                                        <div className="form-group fill">
                                            ...
                                            <input maxLength="256" type="text" onChange={event => { setDESIG_C(event.target.value) }} defaultValue={""} className="form-control" placeholder="Designação..." required />
                                        </div>
                                    </Col>
                            ...
                            <form id="editarItem" onSubmit={editarItemGO} >
                                ...
                                <Row>
                                    ...
                                    <Col sm={8}>
                                        <div className="form-group fill">
                                            <label className="floating-label" htmlFor="Name">Designação <span style={{ color: "red" }} >*</span></label>
                                            <input maxLength="256" type="text" onChange={event => { setDESIG_C(event.target.value) }} defaultValue={itemSelected.DESIG} className="form-control" id="Utilizador" placeholder="Designação..." required />
                                        </div>
                                    </Col>
                    ...
                    <Modal size='x' show={isVerOpen} onHide={() => setVerOpen(false)}>
                        <Modal.Header closeButton>
                            <Modal.Title as="h5">Perfil</Modal.Title>
                        </Modal.Header>
                        <Modal.Body className="newuserbox" >
                            ...
                            <Row>
                                <Col sm={5}>
                                    <div className="form-group fill">
                                        ...
                                        <span className="form-control">{itemSelected.CODIGO}</span>
                                    </div>
                                </Col>
                                ...
                                <Col sm={7}>
                                    <div className="form-group fill">
                                        ...
                                        <span className="form-control">{itemSelected.DESIG}</span>
                                    </div>
                                </Col>
                                ...
                                <div className="col-sm-12">
                                    <div className="form-group fill">
                                        <label className="floating-label" htmlFor="Address">Descrição</label>
                                        <label className="form-control">{itemSelected.DESCR}</label>
