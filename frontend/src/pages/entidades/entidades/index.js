...
const pageAcess = "/entidades/entidades";
    ...
    try {
      ...
      if (response.status == "200") {
        ...
        for (var i = 0; i < response.data.length; i++) {
          ...
          response.data[i].DT_REGISTO = createDate1(
            response.data[i].DT_REGISTO
          );

          response.data[i].PRENTIDADE =
            response.data[i].sgigjprentidadetp.DESIG;
          ...
          response.data[i].action = (
            <React.Fragment>
              ...
              {pageEnable("/entidades/entidades/detalhes", permissoes) ==
                false ? null : (
                <Link
                  to={"/entidades/entidades/detalhes/" + idx}
                  title={pageEnableTitle(
              ...
              {/* {pageEnable("/entidades/entidades/grupo", permissoes) ==
                false ? null : (
                <Link
                  to={"/entidades/entidades/grupo/" + idx}
                  title={pageEnableTitle(
                ...
                >
                  <i
                    className={
                      "" +
                      pageEnableIcon("/entidades/entidades/grupo", permissoes)
                    }
                  />
                </Link>
              )} */}

              {/* {pageEnable("/entidades/entidades/equipamento", permissoes) ==
                false ? null : (
                <Link
                  to={"/entidades/entidades/equipamento/" + idx}
                  title={pageEnableTitle(
              ...
              {/* {pageEnable("/entidades/entidades/banca", permissoes) ==
                false ? null : (
                <Link
                  to={"/entidades/entidades/banca/" + idx}
                  title={pageEnableTitle(
                ...
                >
                  <i
                    className={
                      "" +
                      pageEnableIcon("/entidades/entidades/banca", permissoes)
                    }
                  />
                </Link>
              )} */}

              {/* {pageEnable("/entidades/entidades/maquina", permissoes) ==
                false ? null : (
                <Link
                  to={"/entidades/entidades/maquina/" + idx}
                  title={pageEnableTitle(
                ...
                >
                  <i
                    className={
                      "" +
                      pageEnableIcon("/entidades/entidades/maquina", permissoes)
                    }
                  />
                </Link>
              )} */}

              {/* {pageEnable("/entidades/entidades/colaboradores", permissoes) ==
                false ? null : (
                <Link
                  to={"/entidades/entidades/colaboradores/" + idx}
                  title={pageEnableTitle(
                  ...
                  <Col xl={4} className="task-detail-right">
                    ...
                    >
                      ...
                      >
                        ...
                        <span style={{ color: "#6c757d" }}>
                          {itemSelectedver.CAPITAL_SOCIAL}
                        </span>
                      </div>
