...
const ProcessoFinalizado = () => {
  ...
  const [TIPO_NOTIFICACAO, setTIPO_NOTIFICACAO] = useState("");
  ...
  function opendetalhesdocumentos(e) {
    ...
    console.log("Roberto", e);
    if (e.URL_DOC != null || e.URL_DOC_GERADO != null) {
      list.push({
        DOC_URL: e.URL_DOC ? e.URL_DOC : e.URL_DOC_GERADO,
        sgigjprdocumentotp: {
                  ...
                  <Col xl={8} className="task-detail-right">
                    ...
                    >
                      {itemSelectedver?.sgigjprocessodespacho[0]
                        ?.sgigjrelprocessoinstrutor[0]
                        ?.sgigjrelprocessoinstrucao[0]?.sgigjrelinstrutorpeca !=
                        null && (
                        <div
                          style={{
                            width: "100%",
                        ...
                        >
                          {itemSelectedver?.sgigjprocessodespacho[0]?.sgigjrelprocessoinstrutor[0]?.sgigjrelprocessoinstrucao[0]?.sgigjrelinstrutorpeca?.map(
                            (e) => (
                              <div
                                style={{
                                  padding: "5px",
                ...
                <Row>
                  <Col sm={12}>
                    <Row>
                      ...
                      <Col sm={3}>
                        <div className="form-group fill">
                          <label className="floating-label" htmlFor="tipoNotificacao">
                            Tipo de Notificação <span style={{ color: "red" }}>*</span>
                          </label>
                          <select
                            className="form-control"
                            value={TIPO_NOTIFICACAO}
                            onChange={(event) => setTIPO_NOTIFICACAO(event.target.value)}
                            required
                          >
