...
function Table({ uploadList, columns, data, modalOpen }) {
    ...
    const pageAcess = "/eventos/aprovados"
...
const EventosAprovados = () => {
                        ...
                        if (response.data[i].sgigjreleventodespacho.length > 0) {
                            ...
                            if (response.data[i].sgigjreleventodespacho[0].STATUS == null || response.data[i].sgigjreleventodespacho[0].STATUS == "") response.data[i] = null
                                ...
                                if (response.data[i].sgigjreleventodespacho[0].PR_DECISAO_TP_ID == null) response.data[i] = null
                                    ...
                                    if (response.data[i].sgigjreleventodespacho[0].sgigjprdecisaotp.TIPO != "APROVADO") response.data[i] = null
    ...
    const openDecisao = (itemx) => {
        ...
        parecerEdit = `< p class= "MsoNormal" style = "margin: 0in; line-height: 107%; font-size: 15px; font-family: Calibri, sans-serif; text-align: justify;" > <span style="font-size: 29px; line-height: 107%; font-family: &quot;Ropa Mix Pro&quot;, sans-serif;">Escreva um texto aqui</span></ > `
    ...
    const openVerHandler = async (idx) => {
        ...
        try {
            ...
            const response = await api.get('/sgigjentidadeevento/' + idx);
