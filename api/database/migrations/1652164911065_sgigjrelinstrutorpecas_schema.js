...
class SgigjrelinstrutorpecasSchema extends Schema {
  up () {

    this.create('sgigjrelinstrutorpeca', (table) => {
      ...
      table.string(/*Name*/'PESSOA_TESTEMUNHA_ID'/*Name*/,36).references('ID').inTable(/*Table*/'sgigjpessoa'/*Table*/).onUpdate('CASCADE').onDelete('CASCADE') //key-schema
      ...
      table.integer(/*Name*/'FLAG_NOTA_COMUNICACAO'/*Name*/,/*Size*/11/*Size*/) //data-schema  [T]Number[T]
  ...
  down () {
    this.drop('sgigjrelinstrutorpeca')
  }
}

module.exports = SgigjrelinstrutorpecasSchema
