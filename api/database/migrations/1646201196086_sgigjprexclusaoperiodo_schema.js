...
class SgigjprexclusaoperiodoSchema extends Schema {
  up () {
    this.create('sgigjprexclusaoperiodo', (table) => {
      ...
      table.integer(/*Name*/'NUM_DIAS'/*Name*/,/*Size*/11/*Size*/).notNullable() //data-schema  [T]Number[T]
  ...
  down () {
    this.drop('sgigjprexclusaoperiodo')
  }
}

module.exports = SgigjprexclusaoperiodoSchema
