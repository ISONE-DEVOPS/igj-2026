...
class SgigjprmotivoesclusaotpSchema extends Schema {
  up () {
    this.create('sgigjprmotivoesclusaotp', (table) => {
  ...
  down () {
    this.drop('sgigjprmotivoesclusaotp')
  }
}

module.exports = SgigjprmotivoesclusaotpSchema
