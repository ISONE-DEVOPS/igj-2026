...
class SgigjprnivelescolaridadeSchema extends Schema {

  up () {
    this.create('sgigjprnivelescolaridade', (table) => {
  ...
  down () {
    this.drop('sgigjprnivelescolaridade')
  }

}

module.exports = SgigjprnivelescolaridadeSchema