...
class SgigjprdocumentotpSchema extends Schema {

  up () {
    this.create('sgigjprdocumentotp', (table) => {
      ...
      table.string(/*Name*/'IDENTIFICACAO'/*Name*/,/*Size*/15/*Size*/) //data-schema  [T]Number[T]
  ...
  down () {
    this.drop('sgigjprdocumentotp')
  }

}

module.exports = SgigjprdocumentotpSchema