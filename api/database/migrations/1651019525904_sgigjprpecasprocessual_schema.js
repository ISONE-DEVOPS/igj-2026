...
class SgigjprpecasprocessualSchema extends Schema {
  up () {
    this.create('sgigjprpecasprocessual', (table) => {
  ...
  down () {
    this.drop('sgigjprpecasprocessual')
  }
}

module.exports = SgigjprpecasprocessualSchema
