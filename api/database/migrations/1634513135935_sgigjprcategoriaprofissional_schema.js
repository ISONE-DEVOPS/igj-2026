...
class SgigjprcategoriaprofissionalSchema extends Schema {

  up () {
    this.create('sgigjprcategoriaprofissional', (table) => {
  ...
  down () {
    this.drop('sgigjprcategoriaprofissional')
  }

}

module.exports = SgigjprcategoriaprofissionalSchema