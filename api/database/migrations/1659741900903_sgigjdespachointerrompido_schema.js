...
class SgigjdespachointerrompidoSchema extends Schema {
  up () {
    this.create('sgigjdespachointerrompido', (table) => {
      ...
      table.string(/*Name*/'TIPO'/*Name*/,/*Size*/2/*Size*/).notNullable() //data-schema  [T]Text[T]    
      table.string(/*Name*/'OBS'/*Name*/,/*Size*/64000/*Size*/) //data-schema  [T]Text[T]
      table.string(/*Name*/'OBS_IG'/*Name*/,/*Size*/64000/*Size*/) //data-schema  [T]Text[T]     
  ...
  down () {
    this.drop('sgigjdespachointerrompido')
  }
}

module.exports = SgigjdespachointerrompidoSchema
