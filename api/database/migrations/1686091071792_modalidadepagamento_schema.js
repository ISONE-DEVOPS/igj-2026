...
class ModalidadePagamentoSchema extends Schema {
  up () {
    this.create('modalidadepagamento', (table) => {
  ...
  down () {
    this.drop('modalidadepagamento')
  }
}

module.exports = ModalidadePagamentoSchema
