...
class SgigjprnivellinguisticoSchema extends Schema {

  up () {
    this.create('sgigjprnivellinguistico', (table) => {
  ...
  down () {
    this.drop('sgigjprnivellinguistico')
  }

}

module.exports = SgigjprnivellinguisticoSchema