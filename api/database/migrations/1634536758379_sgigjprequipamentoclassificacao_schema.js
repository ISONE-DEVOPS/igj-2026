...
class SgigjprequipamentoclassificacaoSchema extends Schema {

  up () {
    this.create('sgigjprequipamentoclassificacao', (table) => {
      ...
      table.string(/*Name*/'CLASSIFICACAO'/*Name*/,/*Size*/64/*Size*/).notNullable() //data-schema  [T]Text[T]
  ...
  down () {
    this.drop('sgigjprequipamentoclassificacao')
  }

}

module.exports = SgigjprequipamentoclassificacaoSchema