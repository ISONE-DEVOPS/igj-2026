...
class PagamentoscontribuicoesSchema extends Schema {
  up () {
    this.create('pagamentoscontribuicoes', (table) => {
      ...
      table.string(/*Name*/'contribuicoes_ID'/*Name*/,36).references('ID').inTable(/*Table*/'contribuicoes'/*Table*/).onUpdate('CASCADE').onDelete('CASCADE') //key-schema
  ...
  down () {
    this.drop('pagamentoscontribuicoes')
  }
}

module.exports = PagamentoscontribuicoesSchema
