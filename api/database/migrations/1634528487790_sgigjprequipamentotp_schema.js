...
class SgigjprequipamentotpSchema extends Schema {

  up () {
    this.create('sgigjprequipamentotp', (table) => {
  ...
  down () {
    this.drop('sgigjprequipamentotp')
  }

}

module.exports = SgigjprequipamentotpSchema
