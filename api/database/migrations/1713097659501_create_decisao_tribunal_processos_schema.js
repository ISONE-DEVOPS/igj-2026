...
class CreateDecisaoTribunalProcessosSchema extends Schema {
  up () {
    this.create('decisao_tribunal_processos', (table) => {
  ...
  down () {
    this.drop('decisao_tribunal_processos')
  }
}

module.exports = CreateDecisaoTribunalProcessosSchema
