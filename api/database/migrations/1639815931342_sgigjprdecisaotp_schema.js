...
class SgigjprdecisaotpSchema extends Schema {
  up () {
    this.create('sgigjprdecisaotp', (table) => {
      ...
      table.string(/*Name*/'TIPO'/*Name*/,/*Size*/20/*Size*/).notNullable() //data-schema  [T]Text[T]
  ...
  down () {
    this.drop('sgigjprdecisaotp')
  }
}

module.exports = SgigjprdecisaotpSchema
