...
const controller = "Sgigjentidadebanca";
    ...
    if (allowedMethod || true) {
      ...
      const content = `<div >
        <div style="margin:20px 20px 20px 40px;width: 90%;z-index: 2;">
            ...
            <h2 style="font-size: 12pt !important">Banca</h2>
            ...
            <table style="border-collapse: collapse;font-size: 5pt !important;width: 97%;">
              <thead style="background-color:#2b7fb9;color:#fff">
                <tr>
                   ...
                   <th style="text-align: center;">Tipo de Banca</th>
                   <th style="text-align: center;">Banca</th>
        ...
        <td > ${element.sgigjprbancatp.DESIG}</tb>
        <td > ${element.BANCA}</tb>
      ...
      response.header('Content-Disposition', 'attachment; filename="banca.pdf"')
    ...
    if (allowedMethod || true) {
      ...
      for (let index = 0; index < result.length; index++) {
        ...
        dataResult.push({
          ...
          "Tipo de Banca": element.sgigjprbancatp.DESIG,
          "Banca": element.BANCA,
          "Status": element.sgigjprstatus.DESIG,
          "Data": moment(element.DT_AQUISICAO).format('DD-MM-Y'),
      ...
      response.header('Content-Disposition', 'attachment; filename="banca.csv"')
