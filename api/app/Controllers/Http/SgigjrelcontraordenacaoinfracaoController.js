...
const controller = "Sgigjrelcontraordenacaoinfracao";
...
class SgigjrelcontraordenacaoinfracaoController {
  ...
  async index({ request, response }) {
    ...
    if (allowedMethod) {
      ...
      var result = await Model.query()
        .with('sgigjinfracaocoima.sgigjprinfracaotp')
...
module.exports = SgigjrelcontraordenacaoinfracaoController
