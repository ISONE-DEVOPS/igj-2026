  ...
  if (allowedMethod) {
    ...
    if (validation.status === 'ok') {
      ...
      if (data.TIPO_PROCESSO_EXCLUSAO == 'C') {
        ...
        const INFRACAO_COIMA_ID = data_INFRACAO_COIMA.INFRACAO_COIMA_ID
      ...
      if (newitem.length > 0) {
        ...
        console.log(newitem[0].URL_DOC_GERADO)
        ...
        if (newE === 1) {
          ...
          const newDelete = await Database
